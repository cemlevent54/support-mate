...
import { conflictError } from '../responseHandlers/clientErrors/conflict.error';
import { unauthorizedError } from '../responseHandlers/clientErrors/unauthorized.error';
import { apiSuccess } from '../responseHandlers/api.success';
import { internalServerError } from '../responseHandlers/serverErrors/internalserver.error';
import logger from '../config/logger';
import { Request, Response } from 'express';
import JWTUtils from '../middlewares/jwt.service';
...
export const logoutUser = async (req: Request, res: Response): Promise<void> => {
  logger.info('Logout fonksiyonu çağrıldı', { user: (req as any).user });

...
class SocketManager:
    def __init__(self):
        ...
        self.redis = redis.from_url(REDIS_URL) if REDIS_AVAILABLE else None
    ...
    def register_events(self):
        ...
        async def join_room(sid, data):
            ...
            await self.sio.emit("user_online", {"userId": user_id, "chatId": chat_id}, room=chat_id, skip_sid=sid)
